...
void SchemaRegistry::register_defaults() {
    ...
    // KID no longer registers schemas: *_KID.ini lines are compiled
    // directly to Mora rules (see mora_skyrim_compile/kid_compiler.h)
    // rather than emitted as `ini/kid_*` facts.
}
