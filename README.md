...
`mora compile` writes `mora_patches.bin` directly into your Skyrim
`Data/SKSE/Plugins/` when it detects your install. Drop `MoraRuntime.dll`
alongside it and launch the game.
